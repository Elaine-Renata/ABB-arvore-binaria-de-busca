...
public class ABB {
    ...
    public static void main(String args[]) {
        ...
        arv.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite núm")));
        arv.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite núm")));
        arv.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite núm")));
        arv.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite núm")));
        arv.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite núm")));
        ...
        class BIntNo {
         ...
         class ArvoreBinaria { // Inicio Algoritmo
            private BIntNo Raiz;
            ...
            public void exibirRaiz(){
                System.out.println("A raiz da Árvore é: " + Raiz.valor);
            }
            ...
            public void excluirNo (int item){ // penultimo
                ...
                try{ // antepenultimo
                    ...
                    if (pai == null){
                        ...
                        if (tempNo.dir == null){
                            ...
                            if (tempNo.esq == null){ // original não tem ".esq" nesta linha   
                                if (pai.esq == tempNo){
                                pai.esq = tempNo.dir;
                                }
                                else{
                    ...
                    System.out.println("Erro na exclusão do nó.");
                }
            } // penultimo
        } // Fim Algoritmo